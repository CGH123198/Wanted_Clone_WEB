        ...
        <div className="modal-window">
            <div className="modal-header">
                ...
                <div className="modal-header-center">
                    <span>
                        <svg viewBox="0 0 343 43" className="login-logo">
                            ...
                            <path d="M243.429 41V24.125C243.481 21.0928 245.802 18.5352 248.966 18.5352C252.42 18.5352 254.187 20.8291 254.187 24.7578V41H261.78V22.6484C261.78 15.6875 257.825 11.4688 251.655 11.4688C248.201 11.4688 245.327 13.1035 243.429 15.793V12.5234H235.835V41H243.429Z" ></path><path d="M264.497 26.7617C264.497 35.6211 270.746 42.0547 279.315 42.0547C285.433 42.0547 290.442 38.8643 292.868 33.248L285.538 31.4551C284.325 33.8018 282.137 35.1992 279.315 35.1992C275.545 35.1992 272.908 32.7207 272.249 28.7656H294.028C294.081 28.1064 294.134 27.4473 294.134 26.7617C294.107 17.9023 287.885 11.4688 279.315 11.4688C270.746 11.4688 264.497 17.9023 264.497 26.7617ZM272.592 23.4922C273.066 20.5654 275.519 18.3242 279.315 18.3242C283.06 18.3242 285.485 20.5654 286.013 23.4922H272.592Z"></path><path d="M297.273 2.82031V41H304.866V2.82031H297.273Z" ></path><path d="M309.693 41H322.243C334.794 41 342.256 33.5117 342.282 21.9102C342.256 10.335 334.821 2.82031 322.296 2.82031H309.693V41ZM317.286 34.0391V9.78125H322.296C330.206 9.78125 334.662 14.5537 334.689 21.9102C334.662 29.293 330.18 34.0391 322.243 34.0391H317.286Z"></path>
                        </svg>
                    </span>
                </div>
            ...
            <div className="modal-body">
                <form onSubmit={onSubmit}>
                    ...
                    <ValidationInput id="email" type="email"/>
                    <p className="or-social-login">또는</p>
                    <a href="#">
                        <button type="button" className="social-login-kakao">
                            <img src={kakao} alt="" />
                        </button>
                    </a>
                    ...
                    <p className="company-typography">
                        © Wantedlab, Inc.
                    </p>
