...
const PasswordForm = ({ onSubmit, cancelAuth, getPassword }) => {
    return (
        <div className="modal-window">
            <div className="modal-header">
                <div className="modal-header-left" onClick={cancelAuth} style={{ cursor: "pointer" }}>
            ...
            <div className="modal-body">
                <form onSubmit={onSubmit} >
                    ...
                    <ValidationInput id="password" type="password" getPassword={getPassword}/>
                </form>
            </div>
        </div>
    )
